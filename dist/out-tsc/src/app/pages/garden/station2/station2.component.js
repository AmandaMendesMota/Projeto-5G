...
var station2_service_1 = require("./station2.service");
var Station2Component = /** @class */ (function () {
    function Station2Component(station1Service) {
    ...
    Station2Component = __decorate([
        core_1.Component({
            moduleId: module.id,
            selector: 'ngx-station2',
            templateUrl: './station2.component.html',
        }),
        __metadata("design:paramtypes", [station2_service_1.Station2Service])
    ], Station2Component);
    return Station2Component;
}());
exports.Station2Component = Station2Component;
//# sourceMappingURL=station2.component.js.map